...
import { getColor, HOST } from '@/utils/constants'

const ContactList = ({contacts,isChannel=false}) => {

    const {selectedChatData,setSelectedChatData,setSelectedChatType,selectedChatType,
  ...
  return (
    <div className=' mt-5'>
       { contacts.map((contact) => (
        ...
        >
            <div className='flex gap-5 items-center justify-start text-neutral-300 mx-0'>
                {
                    !isChannel && (
