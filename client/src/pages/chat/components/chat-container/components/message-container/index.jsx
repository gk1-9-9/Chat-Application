...
import { GET_ALL_MESSAGES_ROUTES, GET_CHANNEL_MESSAGES, getColor, HOST } from '@/utils/constants';
...
const MessageContainer = () => {
        ...
        <div className={`${message.sender === selectedChatData._id ? 'text-left' : 'text-right'}`}>
          {
            message.messageType === 'text' && (
              <div className={`${message.sender !== selectedChatData._id ? 
                ...
                'bg-[#2a2b33]/5 text-white/80 border-[#fffff]/20'} 
  ...
  return (
    <div className=' flex-1 overflow-y-auto scrollbar-hidden p-4 px-8 md:[65vw] lg:w-[70vw] xl:w-[80vw] w-full'>
       {renderMessages()}
